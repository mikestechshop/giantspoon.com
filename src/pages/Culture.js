                            ...
                            <ReactFullpage.Wrapper>
                                <SectionWrap className="section" bgc="#0C2340">
                                    <Group
                                        ...
                                        wrap="wrap"
                                    >
                                        {spoonsItems[0].fields.headshot.map(
                                            (x, i) => {
                                                return (
                                                    <HeadshotImg
                                    ...
                                    <Slider
                                        ...
                                        slides={[
                                            <Group height="100vh">
                                                <VimeoPlayer
                                                    id={
                                                        videosItems.spoonsValue1VimeoId
                                                    }
                                                />
                                                <TextBox>
                                                    <OurValues>
                                                    ...
                                                    <Desc>
                                                        ...
                                                        we really mean it. We
                                                        were born out of a
                                                        startup culture. We fail
                                                        fast, break things, then
                                                        dust ourselves off to
                                                        start again. Our best
                                                        work was built because
                                                        someone was dumb, brave,
                                                        or brilliant enough to
                                                        try it. Be like that
                                                        person.
                                                    </Desc>
                                                </TextBox>
                                            ...
                                            <Group height="100vh">
                                                <VimeoPlayer
                                                    id={
                                                        videosItems.spoonsValue2VimeoId
                                                    }
                                                />
                                                <TextBox>
                                                    <OurValues>
                                                    ...
                                                    <Desc>
                                                        We care. Like a lot.
                                                        Maybe even too much. We
                                                        sweat every detail and
                                                        punch up every line. We
                                                        roll up our sleeves and
                                                        go to bat for better
                                                        every day. We give a
                                                        damn and hope you do
                                                        too.
                                                    </Desc>
                                                </TextBox>
                                            </Group>,
                                            <Group height="100vh">
                                                <VimeoPlayer
                                                    id={
                                                        videosItems.spoonsValue3VimeoId
                                                    }
                                                />
                                                <TextBox>
                                                    <OurValues>
                                                    ...
                                                    <Desc>
                                                        As a company founded by
                                                        friends, we’ve always
                                                        had a strong foundation
                                                        of fun. You’d be
                                                        surprised how many
                                                        business problems we’ve
                                                        solved while cracking a
                                                        joke, a beer, or a
                                                        smile. While we care
                                    ...
                                    >
                                        ...
                                        <MediumTextBox>
                                            <MediumText margin="10vh 0vw 2rem">
                                                We love that everyone’s <br />{' '}
                                                strange and personal <br />
                                                journey brought them here.
                                            </MediumText>
                                            <Desc color="#FFFCF2" margin="0">
                                                We hire playwrights, former
                                                politicos, and pro gamers. The
                                                humans we hire are what makes
                                                the work so damn good. Take a
                                                look at some of the Spoons in
                                                our drawer and the weird stuff
                                                they’re into.
                                            </Desc>
                                        </MediumTextBox>
                                    </Group>
